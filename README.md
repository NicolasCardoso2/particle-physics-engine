...
> Motor de simulação 2D desenvolvido com Python e Pygame e arquitetura orientada a objetos. Implementa herança, polimorfismo, Object Pool, Template Method, composição recursiva e física parabolica com drag por frame.
...
| Impacto | Explosão dupla: bola de fogo laranja e faíscas amarelas |
...
| **Física parabolica** | Gravidade e drag aplicados por frame em `Projectile.update()` |
